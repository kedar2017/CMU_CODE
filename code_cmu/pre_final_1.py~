...
def evaluate_lenet5(learning_rate=0.1, n_epochs=200,dataset='mnist.pkl.gz',nkerns=[20, 50], batch_size=5):
	...
	layer2 = LeNetConvPoolLayer(
		rng,
		input=layer1.output,
		image_shape=(batch_size, nkerns[1], 126,158),
	...
	layer3 = LeNetConvPoolLayer(
		rng,
		input=layer2.output,
		image_shape=(batch_size, nkerns[1], 61,77),
		filter_shape=(nkerns[1], nkerns[1], 4, 4),
		poolsize=(2, 2)
	)
	# Layer 4
	layer4 = LeNetConvPoolLayer(
		rng,
		input=layer3.output,
		image_shape=(batch_size, nkerns[1], 29,37),
		filter_shape=(nkerns[1], nkerns[1], 4, 4),
		poolsize=(2, 2)
	)
	# Layer 5
	layer5 = LeNetConvPoolLayer(
		rng,
		input=layer4.output,
		image_shape=(batch_size, nkerns[1], 13,17),
		filter_shape=(nkerns[1], nkerns[1], 4, 4),
		poolsize=(2, 2)
	)
	 # Layer 6
	layer6 = LeNetConvPoolLayer(
		rng,
		input=layer5.output,
		image_shape=(batch_size, nkerns[1], 5,7),
		filter_shape=(nkerns[1], nkerns[1], 4, 4),
		poolsize=(2, 2)
	)
	...
	layer7_input = layer6.output.flatten(2)
